...
constexpr int64_t MAX_QUEUE_SIZE = (15 * 1024 * 1024);
constexpr int64_t MAX_QUEUE_SIZE_VOD = (45 * 1024 * 1024); // 45Mb
...
constexpr int SAMPLE_QUEUE_SIZE = 32;
constexpr int SAMPLE_QUEUE_SIZE_VOD = SAMPLE_QUEUE_SIZE * VOD_MUL;

constexpr int FRAME_QUEUE_SIZE =
        std::max(SAMPLE_QUEUE_SIZE, std::max(VIDEO_PICTURE_QUEUE_SIZE, SUBPICTURE_QUEUE_SIZE));

constexpr int FRAME_QUEUE_SIZE_VOD =
        std::max(SAMPLE_QUEUE_SIZE_VOD, std::max(VIDEO_PICTURE_QUEUE_SIZE_VOD, SUBPICTURE_QUEUE_SIZE_VOD));
